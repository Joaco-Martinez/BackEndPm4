...
exports.getProductsByService = exports.getProductsService = exports.checkProductExists = void 0;
...
const getProductsByService = (itemId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield product_repository_1.ProductRepository.findOneBy({ id: itemId });
});
