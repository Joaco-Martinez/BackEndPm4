...
exports.DB_NAME = process.env.DB_NAME || "pm4front";
exports.DB_USER = process.env.DB_USER || "postgres";
exports.DB_PASSWORD = process.env.DB_PASSWORD || "Joaco1907";
exports.DB_HOST = process.env.DB_HOST || "localhost";
exports.DB_PORT = Number(process.env.DB_PORT) || 5432;
exports.JWT_SECRET = process.env.JWT_SECRET || "claveSecreta";
