...
const productsToPreLoad = [
    {
        name: "iPhone 11",
        price: 699,
        description: "Capture stunning moments with the dual-camera system and enjoy exceptional performance with the iPhone 11.",
    ...
    },
    {
        name: "MacBook Air",
        price: 999,
        description: "Lightweight design meets powerful performance. Perfect for productivity and creativity.",
    ...
    },
    {
        name: "iPad Pro",
        price: 799,
        description: "Stunning display and powerful performance make this the ultimate tablet for work and play.",
    ...
    },
    {
        ...
        price: 399,
        description: "Monitor your health, track your workouts, and stay connected with the sleek Apple Watch.",
    ...
    },
    {
        name: "AirPods Pro",
        price: 249,
        description: "Experience premium sound with active noise cancellation and a customizable fit.",
    ...
    },
    {
        name: "HomePod mini",
        price: 99,
        description: "Smart speaker with great sound and Siri built in. Control your home with your voice.",
    ...
    },
    {
        ...
        price: 1199,
        description: "The latest iPhone with A17 Pro chip, improved camera, and titanium design.",
    ...
    },
    {
        name: "MacBook Pro M3",
        price: 1999,
        description: "Extreme performance with the new M3 chip and Liquid Retina XDR display.",
    ...
    },
    {
        ...
        price: 3499,
        description: "Revolutionary spatial computing with augmented reality and immersive interface.",
    ...
    },
    {
        ...
        price: 129,
        description: "Perfect for taking notes, drawing, and navigating precisely on compatible iPads.",
    ...
    },
    {
        name: "Magic Keyboard",
        price: 99,
        description: "Compact and rechargeable keyboard with precise and comfortable typing experience.",
    ...
    },
    {
        name: "Apple TV 4K",
        price: 179,
        description: "Enjoy 4K HDR content with Dolby Atmos sound and access to Apple TV+.",
